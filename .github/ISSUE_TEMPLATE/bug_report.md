...
**Please search [existing issues](https://github.com/hmseeb/leadrscribe/issues) to avoid duplicates.** Your bug may already be reported! Right now it's just me maintaining this project so many issues can be overwhelming! Help me out by checking first.
