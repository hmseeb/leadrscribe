...
- Background uses dark oklch value
- Border is subtle (1px, dark color)
- @media (prefers-reduced-motion) rule exists
  </verify>
  <done>
...
1. Overlay should appear with smooth scale+fade animation
2. Mic icon should pulse gently during recording
3. Audio bars should animate with audio input
4. Pressing ESC should cancel and overlay should fade out smoothly
  </verify>
  <done>
