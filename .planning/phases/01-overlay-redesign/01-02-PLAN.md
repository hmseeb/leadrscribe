...
2. No warnings about unused variables or unreachable patterns

Then run `bun run tauri dev` and:
1. With overlay_position set to "top" - overlay appears at top center
2. With overlay_position set to "bottom" - overlay appears at bottom center
3. (Manual test later) With "followcursor" - overlay appears near cursor
  </verify>
  <done>
